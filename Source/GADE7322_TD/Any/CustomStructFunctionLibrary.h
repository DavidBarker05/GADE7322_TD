...
public:
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|BooleanStruct|Value",
        meta = (DisplayName = "Break Boolean Struct", ReturnDisplayName = "Boolean", ToolTip = "Breaks a Boolean Struct"
            , NativeBreakFunc))
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|BooleanStruct|Boolean",
        meta = (BlueprintAutocast, DisplayName = "Boolean Struct To Boolean", CompactNodeTitle = "->", ToolTip =
            "Converts a Boolean Struct to a Boolean"))
    static bool FBoolStruct_To_Bool(const FBoolStruct& A);

    UFUNCTION(BlueprintPure, Category = "CustomStructs|BoolStruct|Boolean",
        meta = (BlueprintAutocast, DisplayName = "Boolean To Boolean Struct", CompactNodeTitle = "->", ToolTip =
            "Converts a Boolean to a Boolean Struct"))
...
public:
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|ByteStruct|Value",
        meta = (DisplayName = "Break Byte Struct", ReturnDisplayName = "Byte", ToolTip =
            "Breaks an Byte Struct", NativeBreakFunc))
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|ByteStruct|Byte",
        meta = (BlueprintAutocast, DisplayName = "Byte Struct To Byte", CompactNodeTitle = "->", ToolTip =
            "Converts an Byte Struct to an Byte"))
    static uint8 FUint8Struct_To_Uint8(const FUint8Struct& A);

    UFUNCTION(BlueprintPure, Category = "CustomStructs|ByteStruct|Byte",
        meta = (BlueprintAutocast, DisplayName = "Byte To Byte Struct", CompactNodeTitle = "->", ToolTip =
            "Converts an Byte to an Integer Byte"))
...
public:
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|IntegerStruct|Value",
        meta = (DisplayName = "Break Integer Struct", ReturnDisplayName = "Integer", ToolTip =
            "Breaks an Integer Struct", NativeBreakFunc))
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|IntegerStruct|Integer",
        meta = (BlueprintAutocast, DisplayName = "Integer Struct To Integer", CompactNodeTitle = "->", ToolTip =
            "Converts an Integer Struct to an Integer"))
    static int32 FInt32Struct_To_Int32(const FInt32Struct& A);

    UFUNCTION(BlueprintPure, Category = "CustomStructs|IntegerStruct|Integer",
        meta = (BlueprintAutocast, DisplayName = "Integer To Integer Struct", CompactNodeTitle = "->", ToolTip =
            "Converts an Integer to an Integer Struct"))
...
public:
    UFUNCTION(BlueprintCallable, Category = "CustomStructs|Integer64Struct|Creation",
        meta = (DisplayName = "Make Integer64 Struct", ToolTip = "Makes an Integer64 Struct based on the Integer64",
            NativeMakeFunc))
    static FInt64Struct MakeInt64Struct(int64 InValue);

    UFUNCTION(BlueprintPure, Category = "CustomStructs|Integer64Struct|Value",
        meta = (DisplayName = "Break Integer64 Struct", ReturnDisplayName = "Integer64", ToolTip =
            "Breaks an Integer64 Struct", NativeBreakFunc))
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|Integer64Struct|Integer64",
        meta = (BlueprintAutocast, DisplayName = "Integer64 Struct To Integer64", CompactNodeTitle = "->", ToolTip =
            "Converts an Integer64 Struct to an Integer64"))
    static int64 FInt64Struct_To_Int64(const FInt64Struct& A);

    UFUNCTION(BlueprintPure, Category = "CustomStructs|Integer64Struct|Integer64",
        meta = (BlueprintAutocast, DisplayName = "Integer64 To Integer64 Struct", CompactNodeTitle = "->", ToolTip =
            "Converts an Integer64 to an Integer64 Struct"))
...
public:
    UFUNCTION(BlueprintCallable, Category = "CustomStructs|FloatStruct|Creation",
        meta = (DisplayName = "Make Float Struct", ToolTip = "Makes a Float Struct based on the Float", NativeMakeFunc))
    static FFloatStruct MakeFloatStruct(float InValue);

    UFUNCTION(BlueprintPure, Category = "CustomStructs|FloatStruct|Value",
        meta = (DisplayName = "Break Float Struct", ReturnDisplayName = "Float", ToolTip = "Breaks a Float Struct",
            NativeBreakFunc))
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|FloatStruct|Float",
        meta = (BlueprintAutocast, DisplayName = "Float Struct To Float", CompactNodeTitle = "->", ToolTip =
            "Converts a Float Struct to a Float"))
    static float FFloatStruct_To_Float(const FFloatStruct& A);

    UFUNCTION(BlueprintPure, Category = "CustomStructs|FloatStruct|Float",
        meta = (BlueprintAutocast, DisplayName = "Float To Float Struct", CompactNodeTitle = "->", ToolTip =
            "Converts a Float to a Float Struct"))
...
public:
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|StringStruct|Value",
        meta = (DisplayName = "Break String Struct", ReturnDisplayName = "String", ToolTip = "Breaks a String Struct",
            NativeBreakFunc))
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|StringStruct|String",
        meta = (BlueprintAutocast, DisplayName = "String Struct To String", CompactNodeTitle = "->", ToolTip =
            "Converts a String Struct to a String"))
    static FString FFStringStruct_To_FString(const FFStringStruct& A);

    UFUNCTION(BlueprintPure, Category = "CustomStructs|StringStruct|String",
        meta = (BlueprintAutocast, DisplayName = "String To String Struct", CompactNodeTitle = "->", ToolTip =
            "Converts a String to a String Struct"))
...
public:
    UFUNCTION(BlueprintCallable, Category = "CustomStructs|NameStruct|Creation",
        meta = (DisplayName = "Make Name Struct", ToolTip = "Makes a Name Struct based on the Name", NativeMakeFunc))
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|NameStruct|Name",
        meta = (BlueprintAutocast, DisplayName = "Name Struct To Name", CompactNodeTitle = "->", ToolTip =
            "Converts a Name Struct to a Name"))
    static FName FFNameStruct_To_FName(const FFNameStruct& A);

    UFUNCTION(BlueprintPure, Category = "CustomStructs|NameStruct|Name",
        meta = (BlueprintAutocast, DisplayName = "Name To Name Struct", CompactNodeTitle = "->", ToolTip =
            "Converts a Name to a Name Struct"))
...
public:
    UFUNCTION(BlueprintCallable, Category = "CustomStructs|TextStruct|Creation",
        meta = (DisplayName = "Make Text Struct", ToolTip = "Makes a Text Struct based on the Text", NativeMakeFunc))
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|TextStruct|Text",
        meta = (BlueprintAutocast, DisplayName = "Text Struct To Text", CompactNodeTitle = "->", ToolTip =
            "Converts a Text Struct to a Text"))
    static FText FFTextStruct_To_FText(const FFTextStruct& A);

    UFUNCTION(BlueprintPure, Category = "CustomStructs|TextStruct|Text",
        meta = (BlueprintAutocast, DisplayName = "Text To Text Struct", CompactNodeTitle = "->", ToolTip =
            "Converts a Text to a Text Struct"))
...
public:
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|ObjectStruct|Value",
        meta = (DisplayName = "Break Object Struct", ReturnDisplayName = "Object", ToolTip = "Breaks an Object Struct",
            NativeBreakFunc))
    ...
    UFUNCTION(BlueprintPure, Category = "CustomStructs|ObjectStruct|Object",
        meta = (BlueprintAutocast, DisplayName = "Object Struct To Object", CompactNodeTitle = "->", ToolTip =
            "Converts an Object Struct to an Object"))
    static UObject* FUObjectStruct_To_UObject(const FUObjectStruct& A);

    UFUNCTION(BlueprintPure, Category = "CustomStructs|ObjectStruct|Object",
        meta = (BlueprintAutocast, DisplayName = "Object To Object Struct", CompactNodeTitle = "->", ToolTip =
            "Converts an Object to an Object Struct"))
    ...
    UFUNCTION(BlueprintCallable, Category = "CustomStructs|ObjectStruct|Value",
        meta = (DisplayName = "Get As Type", DeterminesOutputType = "Class", ToolTip =
            "Gets the Object stored in the Object Struct as the class type", ExpandEnumAsExecs = "OutputPins"))
