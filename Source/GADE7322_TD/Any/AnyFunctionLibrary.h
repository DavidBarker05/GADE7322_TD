...
public:
    ...
    UFUNCTION(BlueprintCallable, CustomThunk, Category = "CustomStructs|Any|Creation",
              meta = (DisplayName = "Make Any", CustomStructureParam = "Value", NativeMakeFunc))
    static FAny MakeAny(const int32& Value);

    UFUNCTION(BlueprintPure, Category = "CustomStructs|Any|Value",
              meta = (DisplayName = "Is Valid", ReturnDisplayName = "Is Valid",
                      ToolTip = "Check if the Any contains valid data"))
    ...
    UFUNCTION(
        BlueprintCallable, CustomThunk, Category = "CustomStructs|Any|Value",
        meta =
            (DisplayName = "Get", ExpandEnumAsExecs = "OutputPins", CustomStructureParam = "Value",
             ToolTip =
    ...
    static void AnyGet(UPARAM(ref) const FAny& InAny, EIsAOutputPins& OutputPins, int32& Value);
    ...
    UFUNCTION(BlueprintPure, CustomThunk, Category = "CustomStructs|Any|Creation",
              meta = (BlueprintAutoCast, DisplayName = "To Any", CompactNodeTitle = "->",
                      ToolTip = "Converts a Struct to Any", CustomStructureParam = "Value"))
